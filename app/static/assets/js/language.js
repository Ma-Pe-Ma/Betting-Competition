...
languageSelect.onchange = function() {
    switch(this.value) {
        case 'hu':
            ...
            matchReminderDisplay.innerText = "Meccs-emlékeztetők emailben";
            reminder1Display.innerText = "Azokon a meccsnapokon amelyiken van olyan meccs, amelyiknél nem lett megrakva tét, első meccs előtt egy órával.";
            reminder2Display.innerText = "Minden meccsnap, az első meccs előtt 1 órával.";
        ...
        case 'en': 
            ...
            matchReminderDisplay.innerText = "Match reminder emails";
            reminder1Display.innerText = "On those days when there is a match without my bet (1 hour before first match)";
            reminder2Display.innerText = "Every matchday (1 hour before first match)";
