...
def prev_bets():
    ...
    if username is not None:
        ...
        start_amount = configuration.bet_values.starting_bet_amount
        ...
        group_evaluation_date = time_determiner.parse_datetime_string(configuration.deadline_times.group_evaluation).date().strftime('%Y-%m-%d')
