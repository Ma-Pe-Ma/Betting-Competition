...
match_stats = '''
    SELECT matches.id, datetime, tr1.translation AS team1, tr2.translation AS team2,
...
def get_statistics(language):
    parameters = {'bullseye' : 4.0, 'difference' : 1.0, 'default_max_bet_per_match' : 50, 'l' : language}
